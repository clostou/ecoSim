...
execute_process(
  COMMAND "E:/Applications/Git/cmd/git.exe" --git-dir=.git show-ref "1.4.3"
  WORKING_DIRECTORY "E:/worksapce/ecoSim/external/flac-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/worksapce/ecoSim/external/flac-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/worksapce/ecoSim/external/flac-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
